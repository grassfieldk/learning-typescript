...
//     PartialUser 型の変数 u1 に { name: "Taro" } を代入してコンソールに出力せよ
type PartialUser = ;
const u1: PartialUser = { name: "Taro" };
console.log(u1);

// (2) User から id と name だけを持つ型 UserSummary を Pick を使って定義せよ
//     UserSummary 型の変数 u2 に値を代入してコンソールに出力せよ
type UserSummary = ;
const u2: UserSummary = ;
console.log(u2);

// (3) User から email と age を除いた型 UserWithoutContact を Omit を使って定義せよ
//     UserWithoutContact 型の変数 u3 に値を代入してコンソールに出力せよ
type UserWithoutContact = ;
const u3: UserWithoutContact = ;
console.log(u3);
